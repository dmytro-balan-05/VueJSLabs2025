...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { defineSitemapEventHandler } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/defineSitemapEventHandler';
export { asSitemapUrl } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/asSitemapUrl';
export { getNitroOrigin } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/getNitroOrigin';
export { getSiteConfig } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/getSiteConfig';
export { getSiteIndexable } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/getSiteIndexable';
export { updateSiteConfig } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/updateSiteConfig';
export { useNitroOrigin } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/useNitroOrigin';
export { useSiteConfig } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/useSiteConfig';
export { createSitePathResolver, withSiteTrailingSlash, withSiteUrl } from 'T:/ZTU/VUE/lab-6/node_modules/nuxt-site-config/dist/runtime/server/composables/utils';
export { getBotDetection, isBot, getBotInfo } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getBotDetection';
export { getPathRobotConfig } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getPathRobotConfig';
export { getSiteRobotConfig } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getSiteRobotConfig';
export { useRuntimeConfigNuxtRobots } from 'T:/ZTU/VUE/lab-6/node_modules/@nuxtjs/robots/dist/runtime/server/composables/useRuntimeConfigNuxtRobots';