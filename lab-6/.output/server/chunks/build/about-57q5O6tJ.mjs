import { _ as _sfc_main$2 } from './Card-DZPm8rbz.mjs';
import { defineComponent, withCtx, createVNode, useSlots, computed, unref, mergeProps, renderSlot, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, Fragment, renderList, toRef, inject, isRef, ref, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { Primitive } from 'reka-ui';
import { t as tv, _ as _sfc_main$3, a as _sfc_main$5, b as _sfc_main$4, g as get } from './Button-3RZAQ_YZ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      title: "Про нас - Nuxt Blog",
      description: "Інформація про проект та автора."
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2${_scopeId}>Про проект</h2>`);
          } else {
            return [
              createVNode("h2", null, "Про проект")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p style="${ssrRenderStyle({ "margin-bottom": "15px" })}"${_scopeId}> Цей сайт розроблено в рамках лабораторної роботи №6. </p><ul style="${ssrRenderStyle({ "margin-bottom": "15px", "padding-left": "20px" })}"${_scopeId}><li${_scopeId}>Nuxt 4 Structure (app/ dir)</li><li${_scopeId}>Nitro API Routes</li><li${_scopeId}>Nuxt UI Components</li><li${_scopeId}>SEO (Sitemap, Robots)</li></ul>`);
            _push2(ssrRenderComponent(_component_UAlert, {
              icon: "i-heroicons-information-circle",
              color: "primary",
              variant: "subtle",
              title: "Автор",
              description: "Студент 4-го курсу Балан Дмитро ВТ-22-1"
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode("p", { style: { "margin-bottom": "15px" } }, " Цей сайт розроблено в рамках лабораторної роботи №6. "),
              createVNode("ul", { style: { "margin-bottom": "15px", "padding-left": "20px" } }, [
                createVNode("li", null, "Nuxt 4 Structure (app/ dir)"),
                createVNode("li", null, "Nitro API Routes"),
                createVNode("li", null, "Nuxt UI Components"),
                createVNode("li", null, "SEO (Sitemap, Robots)")
              ]),
...
//# sourceMappingURL=about-57q5O6tJ.mjs.map
